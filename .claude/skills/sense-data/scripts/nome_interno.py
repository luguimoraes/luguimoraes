#!/usr/bin/env python3
"""
Converte o nome de exibição de um campo customizado (ou de uma coluna) no
nome interno no padrão do SenseData: só a-z, 0-9 e _.

Depois de criar o campo, confira o nome interno real em Configurações: em
colisão, a plataforma pode sufixar (cs_feeling -> cs_feeling_2).

Uso:
  python3 nome_interno.py "CS Feeling" "Data da última anotação do CS"
  python3 nome_interno.py --arquivo export_clientes.csv   # usa a 1a linha (, ; | ou tab)
